...
const HabBindSuccessPage = () => {
  const { bindResponse, habResponses, selectedInsurerIndex, resetQuote, habData } = useHab();
  ...
  return (
    <div style={styles.pageContainer}>
      ...
      <div style={styles.buttonContainer}>
        <button onClick={resetQuote} style={styles.button}>Return to Dashboard</button>
      </div>
    </div>
  );
};
